...
- (void)getModel {
    ...
    [sessionManager GET:[NSString stringWithFormat:@"%@chapterId=%@&=%ld",kRead,self.ReadId,(long)_pageCount] parameters:nil progress:^(NSProgress * _Nonnull downloadProgress) {
